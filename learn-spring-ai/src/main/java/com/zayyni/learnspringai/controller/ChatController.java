package com.zayyni.learnspringai.controller;

import com.zayyni.learnspringai.tool.FlightBookingTools;
import com.zayyni.learnspringai.tool.TravellingTools;
...
public class ChatController {
    ...
    public String chat(@RequestBody String message, @RequestParam String userId) {
        ...
        String systemPrompt = String.format("""
                ...
                When calling tools the require a userId, ALWAYS use this exact value
                """, userId);
